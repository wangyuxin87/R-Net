...
from dataset_pre import custom_dataset
...
def train(train_img_path, train_gt_path, pths_path, batch_size, lr, num_workers, epoch_iter, interval, val_img_path,val_gt_path):
	...
	# file_num_new = len(os.listdir(val_img_path))
	...
	model = EAST()
	# model.load_state_dict(torch.load('/home/yxwang/pytorch/EAST/pths/pre_synth/model_epoch_1.pth'))
	...
	# model_dict = model.load_state_dict(torch.load('/home/yxwang/pytorch/EAST/pths/pre_synth/model_epoch_1.pth'))
	best = 100
	...
	for epoch in range(epoch_iter):	
		...
		if (epoch + 1) % interval == 0:
			...
			torch.save(state_dict, os.path.join(pths_path+'/pre_synth/base/7', 'model_epoch_{}.pth'.format(epoch+1)))
		# if (epoch + 1) % 5 == 0:
		# 	epoch_loss_new = 0
		# 	num = 1
			...
			# 	best = epoch_loss_new
			# 	state_dict = model.module.state_dict() if data_parallel else model.state_dict()
			# 	torch.save(state_dict, os.path.join(pths_path + '/pre_synth/', 'model_best.pth'))




if __name__ == '__main__':
	train_img_path = '/home/yxwang/tensorflow/residual/SynthText/txt'
	train_gt_path  = '/home/yxwang/tensorflow/residual/SynthText/txt'
	val_img_path = '/home/yxwang/pytorch/dataset/IC15/image'
	val_gt_path  = '/home/yxwang/pytorch/dataset/IC15/gt'
	pths_path      = '/home/yxwang/pytorch/EAST/pths'
	batch_size     = 16
	lr             = 1e-4
	num_workers    = 16
	epoch_iter     = 10
	save_interval  = 1
	train(train_img_path, train_gt_path, pths_path, batch_size, lr, num_workers, epoch_iter, save_interval,val_img_path,val_gt_path)
